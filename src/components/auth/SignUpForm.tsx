...
const account_types = [
  ...
  { label: "Shop Keeper", value: "shop_keeper" },
                    ...
                    {account_types.map((type) => {
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-xl border px-4 py-3 text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40 ${
                            isActive
